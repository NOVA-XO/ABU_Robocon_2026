...
#define WR_SERVO_DOWN 0     // рак өргөгдсөний дараах сервоны өнцөг (буулгах)
                            //   ⚠ Серво эргүүлж суурилуулсан бол flip-ийг
                            //   Servo_SetDeg дотор ТӨВЛӨРҮҮЛЖ хийнэ — blue/red
                            //   хоёул нэг физик серво тул ижил утгатай (DOWN=0).
#define WR_SERVO_UP 180     // серво буцаах өнцөг (blue-тэй ижил)
