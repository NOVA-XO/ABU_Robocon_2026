  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  while(0){
		  testServo();
		  if(timer>5){
			          shiftAndUpdate(counter0_history, counter[0]);
			  		  shiftAndUpdate(counter1_history, counter[1]);

			  		  int avg0 = movingAverage(counter0_history, 100);
			  		  int avg1 = movingAverage(counter1_history, 100);
	  ...
	  while(0){
		  brushless(0,0,50,0,80,180,0,18000,true);
	  }
  while(1) {
  			test_joyStick;
  		}
	  while(1){
		  ...
		  __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, 24000);
		  __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, 24000);
		  HAL_Delay(2000);
		  while(val1==0){
			  buzzer;
			  if(control_data[2][1]==1)	motor_control(5, 1000);
			  else if(control_data[2][3]==1)	motor_control(5, -1000);
			  else	motor_control(5, 0);
